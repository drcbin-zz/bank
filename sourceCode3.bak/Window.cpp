...
#include "Window.h"
Window::Window(int id, Queue<Customer*>* customerQueue, Queue<Ticket*>* oldTicQueue, condition_variable* workCond, condition_variable* recCond, mutex* customerQueueMutex, mutex* oldTicQueueMutex){
    //初始化信息
